    ...
    for (int tries = 0; tries < numRetries; ++tries) {
      ...
      MetaScannerVisitor visitor = new MetaScannerVisitor() {
        ...
        public boolean processRow(Result rowResult) throws IOException {
          ...
          System.out.println("- [ HRegionInfo info.RegionName ="+info.getRegionNameAsString());
          
          //If regioninfo is null, skip this row
          if (null == info) {
        	  System.out.println("- [ HRegionInfo info == null ]");
            return true;
          }
          if (!(Bytes.equals(info.getTableDesc().getName(), desc.getName()))) {
        	  System.out.println(" - [ !(Bytes.equals(info.getTableDesc().getName(), desc.getName()) ]");
            return false;
          }
          ...
          if (!(info.isOffline() || info.isSplit()) && hostAndPort != null) {
            ...
            System.out.println("- [ after incrementandget, actualRegCount.get() ="+actualRegCount.get());
          }
          return true;
        }
      };
...
//      // -------end test
      ...
      System.out.println("- [ actualRegCount.get() ="+actualRegCount.get());
