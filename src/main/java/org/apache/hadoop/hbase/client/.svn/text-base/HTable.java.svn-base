...
public class HTable implements HTableInterface {
  ...
  private boolean oneColumnFamily = false;// 2013-12-26 Hao
  ...
  //2013-12-26 HuangHao
  public boolean isOneColumnFamily() {
	  return oneColumnFamily;
  }
  
   //2013-12-26 HuangHao
  public void SetOneColumnFamily(boolean ifOneColumnFamily) {
	  this.oneColumnFamily = ifOneColumnFamily;
  }
    ...
    return connection.getRegionServerWithRetries(
        new ServerCallable<Result>(connection, tableName, get.getRow()) {
          public Result call() throws IOException {
        	...
        	//wangsheng 12-7
        	//System.out.println("server.getClass() = "+server.getClass().getSimpleName());
  ...
  protected class ClientScanner implements ResultScanner {
    ...
    private boolean nextScanner(int nbRows, final boolean done) throws IOException {
      ...
      if (this.callable != null) {
        ...
        //System.out.println("I am here htable 1");
      ...
      if (this.currentRegion != null) {
        ...
        if (CLIENT_LOG.isDebugEnabled()) {
    	  ...
    	  //System.out.println("\\\\\\\\this.currentRegion == null////////");
        localStartKey = this.scan.getStartRow();
        //System.out.println("localStartKey = "+ localStartKey);
      ...
      try {
        ...
        getConnection().getRegionServerWithRetries(callable);//scan track: (pre i am here 0) i am here 1.5 (link to i am here 2.5)
    ...
    public Result next() throws IOException {
    	...
    	//System.out.println("i am here Htable.next() line 1138");
