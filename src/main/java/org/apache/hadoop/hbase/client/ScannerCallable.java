...
public class ScannerCallable extends ServerCallable<Result[]> {
  ...
  public Result [] call() throws IOException {
    if (scannerId != -1L && closed) {
    	//System.out.println("here 1 in ScannerCallable.call()");
      close();
    } else if (scannerId == -1L && !closed) {
    	//System.out.println("here 2 in ScannerCallable.call()");
      this.scannerId = openScanner();//scan track: (pre i am here 2.5) i am here 2.6 (link to i am here 3.5)
      //System.out.println("-- scannerId = "+scannerId);
    } else {
    	//System.out.println("here 3 in ScannerCallable.call() -- sever.next(scannerId, caching)");
      Result [] rrs = null;
      try {
...
//	  if (scan.blocked){
//		  System.out.println("- getRegionName"+this.location.getRegionInfo().getRegionName());
//		  System.out.println("- scan"+this.scan);
//	  }
    return this.server.openScanner(this.location.getRegionInfo().getRegionName(),
      this.scan);//scan track: (pre i am here 2.6) i am here 3.5 (link to i am here 4.5)
  }
