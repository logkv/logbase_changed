...
public class Scan implements Writable {
  ...
  private int batch = -1;
  public boolean  regionalScan= false;//huanghao: if it's true, the data supports block-based scan
  ...
  //add a type field to use CR-index
  public boolean CRindex = false;
  public boolean toCreateCRIndex = false;//huanghao
  public boolean toDeleteCRIndex = false;//huanghao
  public byte [] idxColumn = null;//huanghao
  //public byte [] tableName = null;//huanghao
  public int cellNum = 1;//huanghao
  public int blockSize = 50;//huanghao;
  ...
  public Scan(Scan scan) throws IOException {
    ...
    regionalScan = scan.getRegionalScan();
    startBlockID = scan.getStartBlockID();
    ...
    //2013-12-13 wangsheng & huanghao
    CRindex = scan.CRindex;
    toCreateCRIndex = scan.toCreateCRIndex;
    toDeleteCRIndex = scan.toDeleteCRIndex;
    idxColumn = scan.idxColumn;
    //tableName = scan.tableName;
    low = scan.low;
    high = scan.high;
    cellNum = scan.cellNum;
  ...
  //2013-8-3 huanghao add the following 3 functions
  
  public void setRegionalScan(boolean RS) {
	    this.regionalScan = RS;
	  }
  
  public void setStartBlockID(int StartBlockID){
	  this.startBlockID = StartBlockID;
	  this.startRow = Bytes.toBytes("BLOCK_"+String.valueOf(StartBlockID));
  }
  ...
  public boolean getRegionalScan() {
    return regionalScan;
  }
  ...
  public String toString() {
    ...
    sb.append(", regionalScan=");
    sb.append(this.regionalScan);
    sb.append(", startBlockID=");
    sb.append(this.startBlockID);
    //2013-12-13 wangsheng
    sb.append(", CRindex=");
    sb.append(this.CRindex);
    sb.append(", idxColumn=");
    sb.append(this.idxColumn);
    //sb.append(", tableName=");
    //sb.append(this.tableName);
    sb.append(", toCreateCRIndex=");
    sb.append(this.toCreateCRIndex);
    sb.append(", toDeleteCRIndex=");
    sb.append(this.toDeleteCRIndex);
    sb.append(", low=");
    sb.append(this.low);
    sb.append(", high=");
    sb.append(this.high);
    sb.append(", cellNum=");
    sb.append(this.cellNum);
    sb.append(", blockSize=");
  ...
  throws IOException {
    ...
    this.regionalScan = in.readBoolean();
    this.startBlockID = in.readInt();
    //2013-13-13 wangsheng
    this.CRindex = in.readBoolean();
    this.toCreateCRIndex = in.readBoolean();
    this.toDeleteCRIndex = in.readBoolean();
    this.idxColumn = Bytes.readByteArray(in);
    //this.tableName = Bytes.readByteArray(in);
    this.low = in.readDouble();
    this.high = in.readDouble();
    this.cellNum = in.readInt();
  ...
  throws IOException {
    ...
    out.writeBoolean(this.regionalScan);
    out.writeInt(this.startBlockID);
    out.writeBoolean(this.CRindex);
    out.writeBoolean(this.toCreateCRIndex);
    out.writeBoolean(this.toDeleteCRIndex);
    Bytes.writeByteArray(out, this.idxColumn);
    //Bytes.writeByteArray(out, this.tableName);
    out.writeDouble(this.low);
    out.writeDouble(this.high);
    out.writeInt(this.blockSize);
    out.writeInt(this.cellNum);
  ...
  /**
   * New Operation to get data from CR-index
   * This operation need the value range of a specific column
   */
  public void use2ndIndex(byte[] indexedColumn, double minV, double maxV)
  {	  
	  CRindex = true;
	  idxColumn = indexedColumn;
	  //tableName = table;
	  low = minV;
	  high = maxV;
  }
  
  public void toCreate2ndIndex(byte[] indexedColumn, int cellNumber, int blkSize){
	  toCreateCRIndex = true;
	  toDeleteCRIndex = false;
	  idxColumn = indexedColumn;
	  //tableName = table;
	  cellNum = cellNumber;
	  blockSize = blkSize;
  ...
  public void toDelete2ndIndex(byte[] indexedColumn){
	  toDeleteCRIndex = true;
	  toCreateCRIndex = false;
	  idxColumn = indexedColumn;
	  //tableName = table;
  }
