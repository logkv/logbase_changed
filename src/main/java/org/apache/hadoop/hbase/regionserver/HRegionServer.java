...
public class HRegionServer implements HRegionInterface, HBaseRPCErrorHandler,
  ...
  public Result get(byte[] regionName, Get get) throws IOException {
    checkOpen();
    requestCount.incrementAndGet();
//    LOG.info("received get request, regionName: " + new String(regionName) + "; get: " + get.toString());
    try {
//      LOG.info("getRegion(regionName)");
      HRegion region = getRegion(regionName);
  ...
  public long openScanner(byte[] regionName, Scan scan) throws IOException {	
    checkOpen();//
    //if (scan.blocked) System.out.println("++++++++++++**+++++++*++++++++");
    ...
    try {
      ...
      //System.out.println("- region r = " + r.getRegionNameAsString());
      return addScanner(r.getScanner(scan));//scan track: (pre i am here 3.5) i am here 4.5 (link to i am here 5.5)
    } catch (Throwable t) {
