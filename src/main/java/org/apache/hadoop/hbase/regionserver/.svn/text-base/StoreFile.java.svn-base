...
public class StoreFile {
   ...
   */
  boolean isReference() {
    return this.reference != null; // future work after realizing split function. huanghao
  }
  ...
  public static long getMaxSequenceIdInList(List<StoreFile> sfs) {
    ...
    //================================================================
    // code 20130426-1140 commented out by huanghao. 
    // Since there is only one logfile rather than multiple hfile in a store.
    /*
