...
import sg.edu.nus.harmonious.io.HSequenceFile.Metadata;
...
public class SequenceFileLogWriter implements HLog.Writer {
  ...
  // Yuting: Here I didn't use the SequenceFile, instead, I used the HSequenceFile, 
  // because: 1) we need the random seek and thus the sync may incur problems
  // 
  private HSequenceFile.Writer writer;
  ...
  public void init(FileSystem fs, Path path, Configuration conf)
    ...
    this.writer = HSequenceFile.createWriter(fs, conf, path,
      ...
      HSequenceFile.CompressionType.NONE,
      null,
      null,
      new Metadata());
    ...
    if (append) {
      try {
        ...
        LOG.info("this.writer.getClass().getMethod : NoSuchMethodException");
        // Not available
      }
    }
    this.syncFs = m;
...
//    return writer.getValueBeginOffset();
//  }
  ...
  public void sync() throws IOException {
    ...
    //else {
      // LOG.info("cannot sync because syncFs is null");
    //}
  }
