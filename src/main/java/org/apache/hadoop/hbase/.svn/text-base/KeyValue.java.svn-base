...
//    	byte[] row = new byte[this.getRowLength()];
//    	System.arraycopy(this.getBuffer(), this.getRowOffset(), row, 0, this.getRowLength());
//    	System.out.println("row = " + new String(row)+"# length = " + this.getRowLength());
//    	
//    	byte[] family = new byte[this.getFamilyLength()];
//    	System.arraycopy(this.getBuffer(), this.getFamilyOffset(), family, 0, this.getFamilyLength());
//    	System.out.println("family = " + new String(family)+"# length = " + this.getFamilyLength());
//    	
//    	byte[] qualifier = new byte[this.getQualifierLength()];
//    	System.arraycopy(this.getBuffer(), this.getQualifierOffset(), qualifier, 0, this.getQualifierLength());
//    	System.out.println("qualifier = " + new String(qualifier)+"# length = " + this.getQualifierLength());
//    	
//    	row = new byte[o.getRowLength()];
//    	System.arraycopy(o.getBuffer(), o.getRowOffset(), row, 0, o.getRowLength());
//    	System.out.println("o.row = " + new String(row)+"# length = " + o.getRowLength());
//    	
//    	family = new byte[o.getFamilyLength()];
//    	System.arraycopy(o.getBuffer(), o.getFamilyOffset(), family, 0, o.getFamilyLength());
//    	System.out.println("o.family = " + new String(family)+"# length = " + o.getFamilyLength());
//    	
//    	qualifier = new byte[o.getQualifierLength()];
//    	System.arraycopy(o.getBuffer(), o.getQualifierOffset(), qualifier, 0, o.getQualifierLength());
//    	System.out.println("o.qualifier = " + new String(qualifier)+"# length = " + o.getQualifierLength());
//    	
    	//wangsheng 2013-6-1
    	int ret = Bytes.compareTo(this.getBuffer(), this.getRowOffset(), this.getRowLength(), o.getBuffer(), o.getRowOffset(), o.getRowLength());
    	if (ret != 0) return ret;
    	
    	ret = Bytes.compareTo(this.getBuffer(), this.getFamilyOffset(), this.getFamilyLength(), o.getBuffer(), o.getFamilyOffset(), o.getFamilyLength());
    	if (ret != 0) return ret;
    	
    	ret = Bytes.compareTo(this.getBuffer(), this.getQualifierOffset(), this.getQualifierLength(), o.getBuffer(), o.getQualifierOffset(), o.getQualifierLength());
    	if (ret != 0) return ret;
